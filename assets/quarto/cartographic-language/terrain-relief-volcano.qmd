...
p_contours <- ggplot(terrain, aes(x, y)) +
  ...
  coord_equal(expand = FALSE) +
  labs(
    title = "Corbes de nivell i transecte A-A'",
...
p_profile <- ggplot(profile, aes(distance, elevation)) +
  ...
  labs(
    ...
    x = "Distància al llarg del transecte (m)",
    y = "Altitud (m)"
  ) +
...
add_svg_metadata(
  profile_output,
  "Corbes de nivell i perfil topogràfic del mateix transecte",
  "A l'esquerra, un mapa de corbes de nivell de Maunga Whau mostra el transecte A-A prima. A la dreta, el perfil representa l'altitud de cada cel·la al llarg d'aquesta mateixa línia."
)
```
...
![Corbes de nivell i perfil topogràfic calculats sobre el mateix transecte](../../img/cartographic-language/contour-profile-volcano.svg)

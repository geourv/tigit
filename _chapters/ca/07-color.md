...
La separació es produeix perquè el vidre no refracta igual totes les longituds d'ona. Quan la llum passa de l'aire al prisma, la freqüència de cada component es manté, però la seva velocitat de fase i la seva longitud d'ona dins del material canvien. L'índex de refracció $n(\lambda)$ depèn de la longitud d'ona i, per la llei de Snell, determina un angle de refracció diferent per a cada component. En la dispersió normal d'un vidre, les longituds d'ona curtes, pròximes al violeta, es desvien més que les llargues, pròximes al vermell. Com que les dues cares del prisma no són paral·leles, la desviació de la sortida no anul·la la de l'entrada i els feixos emergeixen en direccions diferents. Per tant, no és simplement que el sòlid «retardi» cada color durant un temps diferent: modifica la propagació dins del material i converteix aquesta dependència de la longitud d'ona en una separació angular visible.
...
::: subfigures a/b+c "Descomposició de la llum visible i detecció de radiacions més enllà del vermell i del violeta. Són reconstruccions educatives contemporànies, no fotografies dels muntatges històrics. Font: NASA Science Mission Directorate, «Tour of the Electromagnetic Spectrum»; il·lustracions de Troy Benesch; `PD-NASA` als Estats Units i ús subjecte a les directrius de mitjans de la NASA. Originals sense modificar, excepte la conversió tècnica de WebP a PNG del panell a."
...
La composició reuneix tres operacions diferents. El prisma mostra una separació de la llum visible; el termòmetre converteix en una mesura tèrmica l'efecte d'una radiació invisible; i el clorur de plata actua com a detector químic. Per tant, l'extensió de l'espectre no es va establir «veient» nous colors, sinó observant efectes físics més enllà de la franja que l'ull humà pot percebre.

...
def build_teaching_package() -> None:
    included_files = (
        ...
        (PROJECT_ROOT / "dist" / "teaching" / "chapter-05" / "tigit-05-integracio-sig.xlsx", "dist/teaching/chapter-05/tigit-05-integracio-sig.xlsx"),
        ...
        (PROJECT_ROOT / "scripts" / "check_chapter_05.py", "scripts/check_chapter_05.py"),

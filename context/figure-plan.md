...
| `assets/img/legacy/gis-phases.png` | 5 | `sandbox/geoteaching-tigit-90437e4c4ce3/src/images/png/gis-phases.png` | Obrir el capítol de SIG com a mètode revisable, no com a recepta de programari | Revisió docent; llicència al peu: `Llicència: pendent de revisar.` |

...
Per a visió i retina, el capítol de color utilitza tres recursos de Wikimedia Commons. `assets/img/color-cartography/schematic-human-eye-ca.svg` correspon a `File:Schematic diagram of the human eye ca.svg`, de Jmarchn, 6 de maig de 2016, CC BY-SA 3.0. `assets/img/color-cartography/rod-cone-photoreceptors-ca.svg` correspon a `File:Cone rode ca.svg`, també de Jmarchn, 2014, CC BY-SA 3.0. La síntesi `assets/img/color-cartography/schematic-eye-retina-cells-ca.svg` és una adaptació lingüística al català de l'[SVG de Bfazek](https://commons.wikimedia.org/wiki/File:Schematic_diagram_of_the_eye_and_retina.svg), del 17 d'octubre de 2025, CC BY-SA 4.0; només se n'han traduït les etiquetes i se n'han afegit el títol i la descripció accessibles. La fitxa de Commons indica que es va vectoritzar a partir de Boff et al. i que l'esquema de l'ull adapta treballs de Rhcastilhos i Jmarchn. Aquesta figura connecta el globus ocular amb les capes de la retina i identifica bastons, cons, cèl·lules horitzontals, bipolars, amacrines, ganglionars i glia de Müller.
